...
#'
#' @examples
show_symptoms_cov <- function(data,start_date = as.Date("2020-04-09", tz = "Europe/London"),
  ...
  title_stub <- "Covid symptoms in respondents who show symptoms and not tested positive\n"
  ...
  plot_show_symptoms <-
    ...
    ggplot2::labs( title = chart_title,
                   subtitle = "Counts of symptoms in respondents who show symptoms but not tested\nNote:respondents who tested posiitive are excluded",
                   y = "Counts",
                   x = "Symptoms",
