...
#'
#' @examples
moderate_comorbid_symptoms <- function(data, start_date = as.Date("2020-04-09", tz = "Europe/London"),
  ...
  plot_comorb_moderate <- ggplot2::ggplot(gather_divided_moderate,  ggplot2::aes(Morbidity, Count, group = Symptom)) + #shape = Event,  colour = Event
    ...
    ggplot2::labs(title = chart_title,
                  subtitle = "Counts of symptoms by comorbidities for patients with moderate version of covid",
