...
title_stub <- "Group Age 60+: Asthma across symptoms\n"
...
asthma_model <- glm(asthma ~ shortness_breath + temperature, data = asthma_data, family = binomial)
