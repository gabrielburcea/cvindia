---
title: "liver_disease_18082020_60plus"
...
title_stub <- "Age group 40-59: Liver disease across symptoms\n"
...
```{r}
liver_model <- glm(liver_disease ~ chills + cough + muscle_ache + sore_throat + temperature + joint_pain, data = liver_disease_data, family = binomial)
