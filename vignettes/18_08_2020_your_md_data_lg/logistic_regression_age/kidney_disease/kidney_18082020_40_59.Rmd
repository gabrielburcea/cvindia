...
title_stub <- "Age Group 39-59: Kidney disease across symptoms\n"
...
```{r}
kidney_model <- glm(kidney_disease ~  diarrhoea + muscle_ache + temperature, data = kidney_disease_data, family = binomial)
