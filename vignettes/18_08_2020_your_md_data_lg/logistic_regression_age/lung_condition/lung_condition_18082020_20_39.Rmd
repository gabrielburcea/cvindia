---
title: "lung_condition_18082020_20_39"
...
```{r}
lung_condition_model <- glm(lung_condition ~   cough  + headache + loss_smell_taste + muscle_ache + shortness_breath +
                              sputum + itchy_eyes, data = lung_condition_data, family = binomial)
