...
csvdata_23092020 <- data_categ_nosev

write.csv(csvdata_23092020, file = "/Users/gabrielburcea/Rprojects/data/your.md/cleaned_data_23092020.csv", row.names = FALSE)
