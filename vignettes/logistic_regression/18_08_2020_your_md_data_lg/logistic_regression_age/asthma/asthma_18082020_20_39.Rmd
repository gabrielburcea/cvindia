---
title: "asthma_18_08_2020_20_39data"
...
title_stub <- "Group Age 20-39: Asthma across symptoms\n"
...
asthma_model <- glm(asthma ~ chills + diarrhoea + headache + loss_smell_taste + muscle_ache + 
                      nausea_vomiting + shortness_breath + sputum + temperature + joint_pain + 
                      chest_pain + loss_appetite, data = asthma_data, family = binomial)
