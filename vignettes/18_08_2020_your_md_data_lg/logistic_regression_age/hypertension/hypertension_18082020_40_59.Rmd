---
title: "hypertension_18082020_40_59"
...
```{r}
hypertension_model <- glm(hypertension ~   shortness_breath + sore_throat + temperature + joint_pain,  data = hypertension_data, family = binomial)
