...
dplyr::top_n(all_syptpms_numbers, 10)
...
symptoms_covid_in_resp_numbers <- cvindia::symptom_profile_covid_tested(data = data_select, start_date = as.Date("2020-04-01", format = "%Y-%m-%d"), 
                                           end_date = as.Date("2020-09-01", format = "%Y-%m-%d"),
                                           plot_chart = FALSE)

knitr::kable(symptoms_covid_in_resp_numbers)
