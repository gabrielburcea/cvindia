---
title: "lung_condition_18082020_60plus"
...
```{r}
lung_condition_model <- glm(lung_condition ~   shortness_breath + sore_throat +
                              sputum, data = lung_condition_data, family = binomial)
