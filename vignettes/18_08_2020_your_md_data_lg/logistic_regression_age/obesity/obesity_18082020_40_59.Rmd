...
title_stub <- "Age Group 40-59: Obesity across symptoms\n"
...
```{r}
obesity_model <- glm(obesity ~  cough + diarrhoea + headache + loss_smell_taste + muscle_ache + nasal_congestion + shortness_breath + sore_throat + itchy_eyes +  loss_appetite,  data = obesity_data, family = binomial)
