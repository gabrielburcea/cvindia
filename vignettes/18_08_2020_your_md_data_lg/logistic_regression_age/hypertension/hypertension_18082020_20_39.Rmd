---
title: "hypertension_18082020_20_39"
...
title_stub <- "Age group 20-39: Hypertension across symptoms\n"
...
```{r}
hypertension_model <- glm(hypertension ~ loss_smell_taste +  shortness_breath +  temperature + loss_appetite,  data = hypertension_data, family = binomial)
