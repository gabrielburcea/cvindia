...
title_stub <-  "Age Group 60+: Heart Disease across symptoms\n"
...
heart_disease_model <- glm(heart_disease ~  chest_pain + diarrhoea, data = heart_disease_data, family = binomial)
