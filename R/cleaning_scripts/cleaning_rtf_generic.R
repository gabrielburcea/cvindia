...
# library(forcats)
# data_rec <-
#   read_csv("/Users/gabrielburcea/rprojects/data/your.md/csvdata_1092020.csv")
...
#df_comorb_dist <- distinct(data_comorb, id, .keep_all = TRUE)
# # ###########################################################
...
# gender_table
# care_home_worker <- table(data_categ_nosev$care_home_worker)
# care_home_worker
# health_care_worker <- table(data_categ_nosev$health_care_worker)
# health_care_worker
# data_categ_nosev_cm1_01_09_2020 <- data_categ_nosev
# write.csv(data_categ_nosev_cm1_01_09_2020, file = "/Users/gabrielburcea/Rprojects/stats_data_whole/data_categ_nosev_cm1_01_09_2020.csv", row.names = FALSE)
