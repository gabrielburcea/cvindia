...
title_stub <- "Age group 60+: Diabetes type one across symptoms\n"
...
diabetes_type_two_model <- glm(diabetes_type_two ~  temperature , data = diabetes_type_two_data, family = binomial)
