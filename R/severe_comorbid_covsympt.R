...
#'
#' @examples
severe_comorbid_covsympt <- function(data, start_date = as.Date("2020-04-09", tz = "Europe/London"),
  ...
  plot_comorb_cov_sympt_severe <- ggplot2::ggplot(gather_divided_severe,  ggplot2::aes(Morbidity, Count, group = Symptom)) + #shape = Event,  colour = Event
    ...
    ggplot2::labs(title = chart_title,
                  subtitle = "Counts of SARS-Covid-19 symptoms by comorbidities for patients with severe version of virus",
