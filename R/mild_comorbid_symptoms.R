...
#'
#' @examples
mild_comorbid_symptoms <- function(data, start_date = as.Date("2020-04-09", tz = "Europe/London"),
  ...
  plot_comorb_mild <- ggplot2::ggplot(gather_divided_mild,  ggplot2::aes(Morbidity, Count, group = Symptom)) + #shape = Event,  colour = Event
   ...
   # ggplot2::scale_shape_manual(values = c(7, 6, 5)) +
    ...
    ggplot2::labs(title = chart_title,
                  subtitle = "Counts of symptoms by comorbidities for patients with mild version of covid",
